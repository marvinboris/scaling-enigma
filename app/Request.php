...
class Request extends Model
{
    ...
    protected $fillable = [
        'reqid', 'name', 'platform_id', 'country', 'phone', 'email', 'ref', 'documents', 'issue_id', 'issue_files', 'description', 'status', 'comments', 'admin_files', 'type_id', 'edited_by', 'client_ip', 'client_mac', 'client_browser', 'user_ip', 'user_mac', 'user_browser', 'approved', 'translate'
    ];
