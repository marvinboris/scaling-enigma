...
export const RESET_PERSONALITY = 'RESET_PERSONALITY';
export const PERSONALITY_START = 'PERSONALITY_START';
export const PERSONALITY_SUCCESS = 'PERSONALITY_SUCCESS';
export const PERSONALITY_FAIL = 'PERSONALITY_FAIL';
...
export const PERSONALITIES_START = 'PERSONALITIES_START';
export const PERSONALITIES_SUCCESS = 'PERSONALITIES_SUCCESS';
export const PERSONALITIES_FAIL = 'PERSONALITIES_FAIL';

export const RESET_REQUESTS = 'RESET_REQUESTS';
export const REQUESTS_START = 'REQUESTS_START';
export const REQUESTS_STATUS_START = 'REQUESTS_STATUS_START';
