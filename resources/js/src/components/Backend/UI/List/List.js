                    ...
                    <Row className="align-items-center justify-content-between">
                        <div className="col-6 pb-2 pb-lg-0 col-lg-2">
                            <div className="d-flex align-items-center text-secondary rounded-2">
                                ...
                                <Input type="select" name="show" className="px-3 py-2 text-center rounded-0 h-100 d-block text-reset border-top-0 border-right-0 border-bottom-0 border-black-20 bg-soft" style={{ width: '5rem' }}>
                        ...
                        <div className="col-6 d-lg-none pb-2 pb-lg-0">
                            <Input type="search" className="bg-soft border-0 rounded-2" placeholder="Search..." />
                        </div>
                        ...
                        <div className="col-lg-4 pb-2 pb-lg-0 rounded-2 overflow-hidden">
                            <div className="bg-soft d-flex text-secondary justify-content-around align-items-center font-weight-bold py-3">
                                <a href="{{ route('export.xlsx') }}" className="px-2 export text-decoration-none text-reset"><FontAwesomeIcon icon={faFileExcel} className="text-darkblue mr-2" />Excel</a>
