        ...
        if (loading) content = <Col xs={12}>
            ...
            if (requests) {
                ...
                content = (
                    <>
                        <Row>
                            <List array={requestsData} data={JSON.stringify(requests)} bordered add="File a Request" link="/user/requests/add" icon={faCalendarAlt} title="Attention Requests" className="bg-white shadow-sm"
                                fields={[
...
const mapDispatchToProps = dispatch => ({
    onGetAttentionRequests: () => dispatch(actions.getAttentionRequests()),
