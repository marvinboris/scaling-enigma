...
class Important extends Component {
    ...
    render() {
        ...
        content = (
            <>
                <Row>
                    <List loading={loading} array={requestsData} data={JSON.stringify(requests)} get={this.props.onGetImportantRequests} bordered add="File a Request" link="/user/requests/add" icon={faCalendarAlt} title="Important Requests" className="bg-white shadow-sm"
                        fields={[
...
const mapDispatchToProps = dispatch => ({
    onGetImportantRequests: (page, show, search) => dispatch(actions.getImportantRequests(page, show, search)),
